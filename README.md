# React-Django(CRUD)Application-project
...
- Clone the repository in a local folder
    ```sh
    git clone https://github.com/fizaashraf37/React-Django(CRUD)Application-project.git 
    ```
...
- Nvaigate to cloned project directory
  ```sh
    cd React-Django(CRUD)Application-project
    ```
...
- Open a new terminal and navigate to frontend directory
  ```sh
   cd React-Django(CRUD)Application-project/frontend
    ```
